...
stateChangeProps = [
    ...
    "image", "gradient",
    "text",
    "fill", "stroke", "strokeWidth", "strokeWidthMultiplier"
]
        ...
        class exports[name] extends Layer
                    ...
                    do (state) =>
                        ...
                        for descendant in state.descendants
                            do (descendant) =>
                                ...
                                if descendant instanceof SVGPath
                                    addProps @[descendant.name].parent._children[0], descendant.parent._children[0]
            ...
            animateChildren: (stateName, animate, options={}) ->
                ...
                for dec in @descendants
                    do (dec) =>
                        if dec instanceof SVGPath
                            # dec.stateSwitch(stateName, {animate: animate, options: options})

                            dec.parent._children[0].stateSwitch(stateName, {animate: animate, options: options})
                        else
                            dec.stateSwitch(stateName, {animate: animate, options: options})
